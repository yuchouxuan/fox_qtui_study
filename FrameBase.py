...
class CroDBase(QtWidgets.QLabel):
    ...
    def Point(self,cx,cy,size = 5, col=qt.white,line=False,cod=False,justCord=False):
    ...
    def Line(self,cx0,cy0, cx1,cy1 ,size = 2, col=qt.red, style = qt.SolidLine, unlim= True,arror=False,juestcord=False):
